...
/*********************************** RC522 引脚定义 *********************************************/
#define        macRC522_SPIx                            SPI1
#define        macRC522_SPIx_RCC_CLK_ENABLE()           __HAL_RCC_SPI1_CLK_ENABLE()
#define        macRC522_SPIx_RCC_CLK_DISABLE()          __HAL_RCC_SPI1_CLK_DISABLE()

#define        macRC522_SPI_RCC_CLK_ENABLE()            __HAL_RCC_GPIOB_CLK_ENABLE()
#define        macRC522_GPIO_CS_PORT					GPIOB			//即模块中的SDA
...
#define        macRC522_RST_RCC_CLK_ENABLE()            __HAL_RCB_GPIOC_CLK_ENABLE()
#define        macRC522_GPIO_RST_PORT					GPIOB
#define        macRC522_GPIO_RST_PIN					GPIO_PIN_6
